...
<body>
    <header>
        ...
        <a href="../../Medewerker/Huidig/HuidigeToegangen.php" class="current">Medewerkers</a>
...
<div class="content">
    ...
    <form method="GET">
        ...
        <a href="../Nieuw/NieuweMedewerker.php" class="button" onclick="naamtoevoegen();">Medewerker Toevoegen</a><br><br>
    </form>
