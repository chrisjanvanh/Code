...
<body>
    ...
    <div class="content">
        ...
        <button type="button" class="button">Zoeken</button> <a href="NieuweMedewerker" class="button" onclick="naamtoevoegen(); window.location.href='NieuweMedewerker'; return false;">Medewerker Toevoegen</a><br><br>
        Functie: <br>
